...
public class DataSourceConfig {
	...
	public DruidDataSource master() {
		return new DruidDataSourceFactory.DruidDataSourceBuilder().setUsername("root").setPassword("AE6eiO3r.E1")
				.setUrl("jdbc:mysql://119.31.210.76:3316/intellinews?characterEncoding=utf8&useSSL=false")
				.setFilters("mergeStat").build();
	}
	...
	public DynamicDataSource dynamicDataSource(@Qualifier("master") DruidDataSource master,
			@Qualifier("slave1") DataSource slave1, @Qualifier("slave2") DataSource slave2) {
